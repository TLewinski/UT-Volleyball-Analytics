...
VALUES
  ...
  (11, 18, 13, 29, 3,  8, 0, 0, 2),
  (12, 18,  8, 20, 2,  2, 2, 2, 0),
  (13, 18,  0,  1, 0, 14, 0, 0, 0),
  (14, 18,  8, 19, 0,  1, 0, 6, 0),
  (15, 18,  3,  8, 0,  3, 1, 1, 1),
  (16, 18, 10, 26, 0,  7, 2, 1, 0),
  (17, 18,  8, 20, 2,  2, 1, 2, 2),
  (18, 18,  2,  6, 0,  8, 1, 1, 1),
  (19, 18,  3, 12, 1,  5, 2, 0, 0),

  -- Match 2 vs Ferris State
  (11, 19, 11, 24, 2,  7, 3, 2, 2),
  (12, 19, 14, 33, 4,  2, 0, 4, 0),
  (13, 19,  0,  0, 0, 15, 1, 0, 2),
  (14, 19,  4, 12, 1,  3, 2, 4, 2),
  (15, 19,  3, 12, 1,  3, 0, 1, 1),
  (16, 19,  9, 19, 2,  8, 3, 2, 2),
  (17, 19,  7, 19, 1,  1, 1, 4, 0),
  (18, 19,  2,  6, 1,  5, 0, 1, 0),
  (19, 19,  1,  6, 1,  6, 0, 0, 1),

  -- Match 3 vs Oakland
  (11, 20, 14, 34, 2,  4, 3, 2, 2),
  (12, 20, 13, 31, 3,  3, 0, 1, 0),
  (13, 20,  0,  0, 0, 18, 0, 0, 1),
  (14, 20, 10, 24, 1,  3, 1, 2, 0),
  (15, 20,  3, 12, 1,  7, 2, 0, 2),
  (16, 20,  8, 20, 2,  7, 3, 3, 1),
  (17, 20,  7, 14, 1,  4, 0, 3, 0),
  (18, 20,  0,  1, 0,  7, 0, 1, 2),
  (19, 20,  0,  0, 0,  3, 1, 2, 0),

  -- Match 4 vs Michigan State
  (11, 21, 13, 32, 0,  3, 1, 3, 0),
  (12, 21, 11, 27, 2,  5, 0, 1, 1),
  (13, 21,  0,  1, 0, 15, 1, 0, 0),
  (14, 21,  4, 13, 1,  3, 1, 3, 2),
  (15, 21,  0,  0, 0,  7, 2, 0, 2),
  (16, 21,  8, 21, 1,  8, 0, 2, 2),
  (17, 21,  6, 13, 1,  2, 2, 6, 2),
  (18, 21,  1,  8, 0,  8, 0, 1, 2),
  (19, 21,  1,  4, 1,  5, 0, 0, 1),

  -- Match 5 vs Hope
  (11, 22, 15, 34, 1,  8, 2, 3, 2),
  (12, 22, 12, 29, 0,  3, 0, 2, 1),
  (13, 22,  0,  1, 0, 11, 1, 0, 1),
  (14, 22,  9, 20, 0,  1, 1, 3, 1),
  (15, 22,  1,  6, 1,  3, 3, 1, 1),
  (16, 22,  9, 24, 1,  4, 1, 0, 0),
  (17, 22,  8, 19, 2,  2, 2, 6, 1),
  (18, 22,  2,  8, 0,  7, 0, 0, 2),
  (19, 22,  0,  2, 0,  4, 3, 0, 0),

  -- Match 6 vs Central Michigan
  (11, 23,  8, 19, 0,  5, 1, 2, 1),
  (12, 23, 13, 30, 0,  4, 1, 4, 2),
  (13, 23,  0,  2, 0, 10, 2, 0, 1),
  (14, 23, 10, 21, 0,  2, 0, 3, 1),
  (15, 23,  0,  2, 0,  3, 2, 2, 2),
  (16, 23, 15, 32, 4,  3, 1, 1, 1),
  (17, 23,  4,  8, 1,  1, 0, 5, 1),
  (18, 23,  2, 10, 0,  9, 1, 1, 2),
  (19, 23,  1,  8, 1,  7, 1, 1, 0),

  -- Match 7 vs Wayne State
  (11, 24, 14, 30, 3,  6, 2, 0, 2),
  (12, 24, 10, 26, 0,  3, 2, 3, 0),
  (13, 24,  0,  2, 0, 18, 2, 0, 0),
  (14, 24,  6, 13, 1,  2, 2, 2, 1),
  (15, 24,  3,  9, 0,  4, 3, 2, 1),
  (16, 24, 13, 31, 1,  5, 2, 0, 2),
  (17, 24,  6, 12, 1,  4, 1, 2, 1),
  (18, 24,  1,  7, 1,  6, 0, 0, 0),
  (19, 24,  0,  1, 0,  5, 0, 0, 1),

  -- Match 8 vs Eastern Michigan
  (11, 25, 10, 25, 2,  6, 1, 3, 2),
  (12, 25, 12, 27, 2,  2, 2, 2, 1),
  (13, 25,  0,  1, 0,  8, 2, 0, 1),
  (14, 25,  4, 12, 0,  1, 1, 2, 1),
  (15, 25,  0,  1, 0,  7, 3, 1, 2),
  (16, 25, 10, 22, 1,  3, 1, 2, 0),
  (17, 25,  5, 11, 1,  3, 2, 3, 1),
  (18, 25,  1,  7, 0,  9, 1, 0, 1),
  (19, 25,  0,  0, 0,  3, 1, 2, 1);
